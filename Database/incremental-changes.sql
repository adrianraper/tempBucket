...
-- new titles and licence control
...
-- obsolete or never existed titles
...
-- New version types
INSERT INTO `rack80829`.`T_Version` (`F_VersionCode`, `F_Description`)
VALUES ('Speed', 'Speed package');

-- New Road to IELTS
delete from T_Product where F_ProductCode in (72,73);
delete from T_ProductLanguage where F_ProductCode in (72,73);
delete from T_ProductVersion where F_ProductCode in (72,73);
INSERT INTO `T_Product` (`F_ProductCode`, `F_ProductName`, F_ProductImageURL, F_DisplayOrder, F_ArchitectureVersion) VALUES ('72', 'Road to IELTS Academic','https://www.clarityenglish.com/images/program/r2i/r2i-icon.png',7,4);
INSERT INTO `T_Product` (`F_ProductCode`, `F_ProductName`, F_ProductImageURL, F_DisplayOrder, F_ArchitectureVersion) VALUES ('73', 'Road to IELTS General Training','https://www.clarityenglish.com/images/program/r2i/r2i-icon.png',7,4);
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('72', 'FV');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('72', 'R2ILM');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('72', 'R2ITD');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('72', 'Speed');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('73', 'FV');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('73', 'R2ILM');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('73', 'R2ITD');
INSERT INTO `T_ProductVersion` (`F_ProductCode`, `F_VersionCode`) VALUES ('73', 'Speed');
...
INSERT INTO `T_Product` (`F_ProductCode`, `F_ProductName`, F_ProductImageURL, F_DisplayOrder, F_ArchitectureVersion) VALUES ('69', 'Active Reading V11','https://www.clarityenglish.com/images/program/ar/ar-icon.png',8,4);
...
INSERT INTO `T_Product` (`F_ProductCode`, `F_ProductName`, F_ProductImageURL, F_DisplayOrder, F_ArchitectureVersion) VALUES ('70', 'Practical Writing','https://www.clarityenglish.com/images/program/pw/pw-icon.png',8,4);
...
-- update production database scripts
