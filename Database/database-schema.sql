...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `rack80829` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `rack80829`;
...
) ENGINE=InnoDB AUTO_INCREMENT=14028 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=22148 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=192620 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `T_Score` (
  ...
  `F_ProductCode` smallint(5) DEFAULT NULL,
  PRIMARY KEY (`F_UserID`,`F_ExerciseID`,`F_DateStamp`),
...
-- ALTER TABLE `rack80829`.`T_Score` ADD COLUMN `F_ProductCode` SMALLINT(5) NULL DEFAULT NULL  AFTER `F_CourseID` ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2065724 DEFAULT CHARSET=latin1
...
) ENGINE=InnoDB AUTO_INCREMENT=244570 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `T_Offer` (
  ...
  `F_OfferName` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `F_PackageID` SMALLINT(5) NOT NULL,
  `F_Duration` SMALLINT(5) NULL,
  `F_Currency` VARCHAR(3) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'HKD',
  `F_Price` DECIMAL(18, 2) NOT NULL DEFAULT 0,
  `F_OfferStartDate` DATETIME NULL,
  `F_OfferEndDate` DATETIME NULL,
...
CREATE TABLE `T_Package` (
  `F_PackageID` SMALLINT(5) NOT NULL,
  `F_PackageName` VARCHAR(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- 
-- Table structure for T_DirectStart
--
...
-- Dump completed on 2011-06-10  9:03:31
