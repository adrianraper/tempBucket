...
var g_startingPoint = "<?php echo $_SESSION['startingPoint']; ?>";
var g_referer = "<?php echo $_GET['from']; ?>";
...
var progressControl = webShare + "/SoftwareBeta/ResultsManager/web/";
var coordsWidth = 745; var coordsHeight = 540;

var flashvars = {
	host: "http://<?php echo $_SERVER['HTTP_HOST'];?>/SoftwareBeta/ResultsManager/web/",
