...
<title>It's Your Job - Resources</title>
<!--CSS General-->
<link rel="stylesheet" type="text/css" href="../css/tab.css" />
<!--Tab function-->
<script type="text/javascript" src="../script/yetii.js"></script>
<!-- Clarity recorder -->
<!-- July 2010 - replace with V4.0.1 -->
...
<applet id="nanogong" archive="/Software/Recorder/nanogong.jar" code="gong.NanoGong" width="1" height="1">
	<param name="AudioFormat" value="Speex" />
</applet>
<script type="text/javascript">
var startControl = "/Software/Common/";
...
swfobject.embedSWF("/Software/Recorder/" + "ClarityRecorder.swf?" + cacheKiller, "altContentClarityRecorder", coordsWidth, coordsHeight, "9.0.0", expressInstall, flashvarsClarityRecorder, paramsClarityRecorder, attrClarityRecorder);
-->
<script type="text/javascript">
	// ****
	// Change this variable along with the above fixed paths
	var webShare = "";
	var coordsWidth = "680"; var coordsHeight = "179";
	// 
	// *********

	var startControl = webShare + "/Software/";
	var flashvars = { };
	var params = {
		scale: "noScale"
	};
	...
	swfobject.embedSWF(startControl + "Recorder/bin/WebRecorder.swf", "altContentClarityRecorder", coordsWidth, coordsHeight, "10.1", expressInstall, flashvars, params, attr);
</script>
...
<div class="tab_links_ref_area"><a href="javascript:tabber3.previous()">Previous</a> | <a href="javascript:tabber3.next()">Next</a></div>
</div>
</div>
</div>
...
<ul class="detail_table_arrow" id="tab-container-tips">
	...
	<p class="heading">Tip 2</p>
	Don’t lie in your resume. This includes “massaging” dates. If you are caught out, you lose a job opportunity. For employers a dishonest applicant will probably be a dishonest employee.</div>
	<div class="tab-tips" id="tips3">
	<p class="heading">Tip 3</p>
	When you’ve sent in your application, don’t take calls about it at work. It embarrassing you disappear into the corridor to talk on your mobile. Everybody knows what is happening. Arrange to call back later.</div>
	<div class="tab-tips" id="tips4">
	<p class="heading">Tip 4</p>
	Modify your resume to fit the job you are applying for, and showcase your most relevant qualifications and experience. This will impress employers because it shows you have taken the trouble to research their company.</div>
	<div class="tab-tips" id="tips5">
	<p class="heading">Tip 5</p>
	If you are sending your resume by email, send it as a pdf. This way you can be sure that the employers will see the document as you laid it out.</div>
	</div>
	<div class="tab_links_area"><a href="javascript:tabber2.previous()">Previous</a> | <a href="javascript:tabber2.next()">Next</a></div>
</ul>
</div>
</div>
...
<div style="height: 140px; padding: 0px 0 0 0px;">
<div id="altContentClarityRecorder" >
	<div style="height: 100px; width: 500px; padding: 20px 0 0 20px;">
	<p>This application requires Adobe's Flash player, running at least version 10.1</p>
	<p>It seems your browser doesn't have this. Please download the latest Adobe Flash Player by clicking on the button below.</br></p>
	<p align="center"><a href="http://www.adobe.com/go/getflashplayer" target="_blank"><img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player" border="0"/></a></p>
