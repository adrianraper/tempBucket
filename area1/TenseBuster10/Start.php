<?php
	...
	// For this product
	$productCode = 55; // TenseBuster 10
	$swfName = 'TenseBuster.swf';
	$webShare = '';
	$startControl = "$webShare/Software/BentoTitles/TenseBuster/bin-debug/";
...
<html>
<head>
	<title>TenseBuster from Clarity</title>
...
<body style="background-color:#FFFFFF;">
	<div style="background-color:#FFFFFF;" align="center" id="altContent">
