<?php
	...
	/*
	if (isset($_SESSION['BusinessWriting'])) {
		$version = $_SESSION['BusinessWriting']->languageCode;
	...
	*/
	// If you want to allow a BW licence to avoid the Job unit and add a certificate
	if ($prefix == 'CSTDI') {
...
<html>
<head>
	<title>Business Writing from Clarity</title>
