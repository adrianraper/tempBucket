<?php 
	...
	if( (session_is_registered('UserID') == 0) OR ($_SESSION['UserType']==0) ){
...
<div id="container">
  <div id="header"></div>
      ...
      <div id="menu">
            ...
            <div id="footer">
        	<div id="footer_line">
Data &copy; University of York, 2011. Authors: Chris Copland and Huw Jones.<br />Software &copy; Clarity Language Consultants Ltd, 2011. All rights reserved.<br />
