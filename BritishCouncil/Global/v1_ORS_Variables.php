<?php
	...
	// The debugLog gives messages at all points
	$debugLog = true;
	$debugLogFile = "D:\\fixbench\\tmp\\GRTI_debug.log";
	// The errorLog just writes messages when we have an error
	$errorLog = true;
	$errorLogFile = "D:\\fixbench\\tmp\\GRTI_error.log";
