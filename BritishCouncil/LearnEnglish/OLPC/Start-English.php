...
<head>
	...
	<script language="JavaScript" type="text/javascript">
		...
		if (swfobject.getQueryParamValue("resize")=="true") {;
			...
			var coordsWidth = 760; var coordsHeight = 400;
		}
		...
		swfobject.embedSWF(startControl + "control-OLPC.swf" + argList, "altContent", coordsWidth, coordsHeight, "9.0.28", expressInstall, flashvars, params, attr);
	</script>
<style type="text/css">
html, body {
	margin: 0px 0px auto;
