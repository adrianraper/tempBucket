...
<head>
<title>British Council LearnEnglish Level Test Malaysia - registration</title>
...
<div id="userAdminBar"><!--Welcome to British Council | <a href="logout.php">Logout</a> | <a href="mailto:support@clarityenglish.com">Contact us</a>--></div>
	<div id="userDetails_form">
		<div id="addlearner_title">
			<p>Welcome to the LearnEnglish Level test Malaysia.</p>
			<p>Please type your name and email below. We will keep a record of your personal details along with your test result. This information will not be made available to any third party unless you have already given us permission to do so. At the end of the test you will get instructions on the next step.</p>
		</div>
		<div>
			<form id="loginForm" name="loginForm" onSubmit="return false;">
				<div class="login_line">
                    ...
                    <p class="labelNote"><label for="learnerName" id="learnerNameNote">This name will be shown on your result.</label></p>
                    <div class="clear"></div>
                </div>
                <div class="login_line">
                    ...
                    <p class="labelNote"><label for="learnerEmail" id="learnerEmailNote" >Your email is used to find your result later.</label></p>
                      <div class="clear"></div>
                </div>
