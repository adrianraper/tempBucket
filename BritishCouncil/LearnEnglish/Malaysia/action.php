...
if ($queryMethod=="addNewUser") {
	...
	// Build a hash of the email and save as the ID
	$ctx = hash_init('sha1');
	...
	$LoginAPI['country'] = 'Malaysia';
	$LoginAPI['emailTemplateID'] = 'BC-Malaysia-LearnEnglishLevelTest';
	...
	if($contents === false){
		...
		if ($errorCode == 0) {
			...
			$rc['redirect']=$thisDomain.$startFolder."Start.php?prefix=$prefix";
