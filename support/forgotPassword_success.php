...
<div id="container_position">
  ...
  <p class="para">Your password has been sent to <?PHP echo $email;?>.</p>
  <p class="para">If you don't receive an email from us shortly, <br />please <a href="mailto:support@clarityenglish.com?subject=forgot password enquiry">email</a> our support team.</p>
</div>
