	...
	submitTestData = function() {
		...
		$.ajax({
			...
			data: {operation: 'submitAnswers', answers: answers, code: $("#codeHolder").text(), user: $("#registrationForm").serialize(), prefix: prefix, productCode: productCode},
			dataType: "json",
    	        ...
    	        rules: {
    	          ...
    	          userEmail: {
    	        	remote: {
    	        	  type: "POST",
    	        	  url: "/Software/ResultsManager/web/amfphp/services/TB6weeksService.php",
    	        	  data: {operation: 'isEmailValid', prefix: getURLParameter('prefix'), productCode: productCode},
    	        	  dataType: "json",
    	        	  dataFilter: function(data, dataType) {
    	        		  var decodedData = jQuery.parseJSON(data);
	    	  				if (decodedData == 'new user') {
	    						...
	    						$("#validationMessage").text("This email is linked to a different account. Use another.");
	    						return false;
