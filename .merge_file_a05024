package com.clarityenglish.activereading.view.login {
	...
	public class LoginView extends BentoView implements LoginComponent {
		...
		[SkinPart]
		public var forgetPasswordButton:Button;
		...
		protected override function partAdded(partName:String, instance:Object):void {
			...
			switch (instance) {
				...
				case forgetPasswordButton:
					forgetPasswordButton.label = copyProvider.getCopyForId("forgotPasswordLabel");
					forgetPasswordButton.addEventListener(MouseEvent.CLICK, forgotPasswordHandler);
					break;
			}
		}
		...
		protected function forgotPasswordHandler(event:MouseEvent):void {
			...
			substTags.rootID = (config.rootID) ? config.rootID : 0;
