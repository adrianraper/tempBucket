package  
{
	 ...
	 * @author Adrian Raper
	 *
	 * This assumes that you are NOT online and you are running from a file (MDM).
	 *
	 ...
	 */
	public class MyMDMLocalBadger  extends MovieClip
	{
		
		public function MyMDMLocalBadger() 
		{
			...
			var airBrowserPath:String = "../../Software/Common/air.swf";
			myTrace("full path=" + airBrowserPath);
			try {
				...
				airSWFLoader.load(new URLRequest(airBrowserPath),  loaderContext);
			} catch (e:Error) {
				myTrace(e.message);
			} 
			...
			function didRecorderStart(e:TimerEvent):void {
				...
				myTrace("did recorder start? er, not yet");
