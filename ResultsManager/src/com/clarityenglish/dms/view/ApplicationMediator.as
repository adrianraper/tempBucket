/*
 Mediator - PureMVC
 */
package com.clarityenglish.dms.view {
	...
	import com.clarityenglish.dms.view.email.EmailMediator;
	...
	public class ApplicationMediator extends AbstractApplicationMediator implements IMediator {
		...
		private function get application():DMSApplication {
			return viewComponent as DMSApplication;
		}
		...
		override public function onRegister():void {
			...
			facade.registerMediator(new AccountMediator(application.accountView));
			facade.registerMediator(new EmailMediator(application.emailView));
