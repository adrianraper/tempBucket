...
<html>
	<head>
		...
		<title>Clarity English - new account</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="600" >
  ...
  {else}
	  ...
	  <tr align="left" valign="top">
    		<td height="28" class="style1">New account: <strong>{$account->name}</strong></td>
  ...
  <tr align="left" valign="top">
	...
	{if $individual!='true'}
		This email is to welcome you as the administrator for this new account on www.ClarityEnglish.com.
	{else}
		This email is to welcome you to your account on www.ClarityEnglish.com.
	{/if}
	Listed below are licence details of the
	{if $account->titles|@count > 1}programs
	{else}program
	{/if} you have subscribed to. There is a section explaining how you can accept the terms and conditions of the subscription and a section on 
	how to get the support you {if $individual!='true'}and your colleagues {/if}need.
	{foreach name=orderDetails from=$account->titles item=title}
...
-->
  <tr align="left" valign="top">
    <td class="style1">
		<b>Login at www.ClarityEnglish.com</b>. This website will let you{if $individual!='true'}, your colleagues and learners{/if}
  ...
  <tr align="left" valign="top">
    <td class="style1">
		Your {if $individual!='true'}admin {/if}account:<br/> 
		Login name: {$account->adminUser->name}<br/>
		Password: {$account->adminUser->password}<br/>
	</td>
  </tr>
  ...
  {if $individual!='true'}<tr align="left" valign="top">
    <td class="style1">
...
<table border="0" cellpadding="0" cellspacing="0" width="600" >
  ...
  <tr><td class="style1">
<br/><a style="background-color:#FFFF00"><b>3. Accepting the terms and conditions.</b></a><br/>
		The first thing that you need to do is to accept the terms and conditions of the subscription.
		None of the titles will be active until you have done this.
		Please go to www.ClarityEnglish.com and login with your {if $individual!='true'}admin {/if}account. You will automatically
		be shown the terms and conditions, which you can read and choose to accept.
	</td></tr>
  <tr align="left" valign="top">
    <td height="10"></td>
  </tr>
...
-->
  <tr align="left" valign="top">
    <td class="style1">
		<br/><a style="background-color:#FFFF00"><b>4. Support.</b></a><br/>
