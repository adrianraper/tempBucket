...
<html>
	<head>
		...
		<title>Clarity English - subscription termination</title>
		<!-- <from>accounts@clarityenglish.com</from> -->
		<!-- <cc>accounts@clarityenglish.com</cc> -->
		<!-- <bcc>andrew.stokes@clarityenglish.com,wan.zahrah@clarityenglish.com</bcc> -->
<style type="text/css">
{literal}
<!--
...
<table border="0" cellpadding="0" cellspacing="0" width="600" >
  ...
  <tr align="left" valign="top">
	...
	{else}program
	{/if} in your account expired a week ago.
		<strong>
		{if $individual!='true'}Your students
		{else}You
		{/if} no longer have access.
		</strong>
		...
		{if $individual!='true'}We will continue to keep your learner's progress records for a short while but will delete them if you choose not to renew.{/if}
...
<table border="0" cellpadding="0" cellspacing="0" width="600" >
  ...
  <tr align="left" valign="top">
	...
	If you do want to recover access to {if $countExpiringTitles>1 }these programs
	{else}this program
	{/if}
