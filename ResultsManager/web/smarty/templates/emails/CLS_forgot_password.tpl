...
<table style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;" width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr align="left" valign="top">
	...
	<p style="margin: 0 0 10px 0; padding:0;">Thank you for subscribing to ClarityLifeSkills.</p>
	...
	<p style="margin: 0 0 10px 0; padding:0;">If you wish to change this info, you can do so at any time by logging into ClarityLifeSkills and go to the My Account page.</p>
