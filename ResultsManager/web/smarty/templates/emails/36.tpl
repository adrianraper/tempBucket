...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 10px 0; padding:0; color:#000000;">I hope you, your colleagues and your learners have found your Clarity programs both useful and enjoyable – and I hope you are intending to renew. If so, please send a quick email to <a href="mailto:sales@clarityenglish.com?Subject=Account%20renewal">sales@clarityenglish.com</a>, or to me, and we can set the renewal process in motion.</p>
<!--
