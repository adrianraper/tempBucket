...
<body id="buy_page">
			<div id="content_box_buy">
                                     ...
                                     <div class="buy_field_box">
                                         ...
                                         <div class="buy_inner_box">
                                                     ...
                                                     <div class="buy_field_line">
                                                        <p class="error" name="RTIProductError" id="RTIProductError" style="display:none"></p>
                                                     </div>
                                     ...
                                     <div class="buy_field_box">
                                         ...
                                         <div class="buy_inner_box">
                                            <div class="buy_field_line">
                                                ...
                                                <input name="RTIChooseEmail" id="RTIChooseEmail" type="text" class="field" value="tandan_shiva@yahoo.com" onblur="checkEmail()"/>
                                     ...
                                     <div class="buy_field_box">
                                         ...
                                         <div class="buy_inner_box">
                                            ...
                                            <div class="buy_field_line">
                                                ...
                                                <input name="RTIPhone" id="RTIPhone" type="text" class="field" value="999" />
                                            ...
                                            <div class="buy_field_line">
                                                <input name="RTINewsletter" id="RTINewsletter" type="checkbox" value="" />I would like to receive future issues of Clarity's newsletter.
                                            </div>
                         ...
                         <div class="buy_payment_line_on">
                            <p class="card" id="visa"><input name="R2ISelectPayment" id="R2ISelectPaymentVisa" type="radio" value="Visa" class="radio" checked="yes"/>Visa   <input name="R2ISelectPayment" id="R2ISelectPaymentMC" type="radio" value="MC" class="radio"/>Master card</p>
                            
                            <div class="clear"></div>

                            <p id="paypal"><input name="R2ISelectPayment" id="R2ISelectPaymentPP" type="radio" value="PP" class="radio"/>PayPal Express Checkout</p>
                            <div class="clear"></div>

                            <p id="transfer">
                            	<input name="R2ISelectPayment" id="R2ISelectPaymentMT" type="radio" value="MT" class="radio"/>Money Transfer
                                <span class="money_note">(Via Western Union or Money Gram)</span>
                            <input name="R2ISelectPayment" id="R2ISelectPaymentDB" type="radio" value="DB" class="radio"/>Direct Bank Deposit</p>
                            <div class="clear"></div>
                         </div>                                    
                                     
                                     <div class="buy_button_area">
                                        <div class="btn_blue_general" onclick="processCheckOut()">Send</div>
