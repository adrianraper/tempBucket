...
echo ('swfobject.embedSWF("http://'.$_SERVER['HTTP_HOST'].'/Software/Widget/IELTS/bin/BandScoreCalculator-'.$swfWidth.'.swf", "BandScoreCalculator", "'.$dataWidth.'", "'.$dataHeight.'", "9.0.28", null, flashVars, params);');
echo ('document.write("<div id=\"BandScoreCalculator\" >Replace with widget</div>");');
?>
