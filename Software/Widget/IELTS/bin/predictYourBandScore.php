...
echo ('swfobject.embedSWF("http://'.$_SERVER['HTTP_HOST'].'/Software/Widget/IELTS/bin/PredictYourBandScore-'.$swfWidth.'.swf", "PredictYourBandScore", "'.$dataWidth.'", "'.$dataHeight.'", "9.0.28", null, flashVars, params);');
echo ('document.write("<div id=\"PredictYourBandScore\" >Replace with widget</div>");');
?>
