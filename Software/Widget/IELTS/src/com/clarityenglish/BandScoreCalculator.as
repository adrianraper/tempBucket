package com.clarityenglish
{
	...
	public class BandScoreCalculator extends MovieClip
	{
		...
		private function loadedHandler(e:Event):void {
			...
			// TODO: Check that we can cope with this country
			// This is ridiculous as we don't know list of all countries. So we need to do validation somewhere else
			/*
			switch (websiteCountry.toLowerCase()) {
				case "thailand":
		...
		private function initLiterals(e:Event):void {
			...
			if (!this.literals.literalExists('moreInfo' + websiteCountry)) {
				websiteCountry = 'Global';
			}
