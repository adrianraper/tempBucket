	...
	function output() {
		...
		switch ($this->type) {
			...
			case 'audio':
				 ...
				 */			 
				/*$build.= '<audio-player src="../media/'.$this->filename.'" controls="full">';*/
				/*<audio-player src="../media/audio/SSS_Aud_U06E09_01_NPXR.mp3" controls="full">
				</audio-player>*/
				
				//audio will not display here. It should be at the top.
				break;
			case 'video':
        ...
        */
        ...
        switch ($this->type) {
            case 'url':
                $build .= '>'.$this->name.'</a>';
                break;
            case 'audio': //audio will not display here. It should be at the top.
				break; 
            case 'video':
                $build .= '</'.$this->type.'>';
                break;
