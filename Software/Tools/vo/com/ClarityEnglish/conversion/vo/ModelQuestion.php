...
class ModelQuestion implements JsonSerializable {
    ...
    public function jsonSerialize() {
		...
		if (isset($this->marker)) $rc['showClickMarker'] = $this->marker;
		if (isset($this->multipleAnswers)) $rc['allowMultipleAnswers'] = $this->multipleAnswers;
        return $rc;
    }
}
