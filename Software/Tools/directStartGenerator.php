...
<html lang="en">
  <head>
    ...
    <title>ClarityEnglish integration demo</title>
	...
	<div class="dpt-register-bg">
        <div class="container">
              <div class="row price-box">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6">
                      <div class="lead-detail general-shadow">
                          ...
                          <form id="userDetails">
                              <div>
                                  <ol class="price-step">
                                      <li class="general-bold-tag">Please type your details.</li>
                                  </ol>
                              </div>

                              <div class="form-group">
                                  <input id="name" type="text" class="form-control general-text"
                                         placeholder="identifier">
                                  <input id="prefix" type="text" class="form-control general-text"
                                         placeholder="prefix">
                                  <input id="key" type="text" class="form-control general-text"
                              ...
                              <div>
                                  <p class="general-bold-tag">2. Start a Clarity title</p>
                              </div>
                              <div class="general-button-box">
                                  <button id="btnStartDPT" type="button"
                                          class="btn-dpt">DPT
                                  </button>
                              </div>
                              <div class="general-button-box">
                                  <button id="btnStartTB" type="button"
                                          class="btn-dpt">Tense Buster
                                  </button>
                              </div>
                              <div class="general-button-box">
                                  <button id="btnStartSSS" type="button"
                                          class="btn-dpt">Study Skills Success
                                  </button>
                              </div>
                              <div class="general-button-box">
                                  <button id="btnStartCP1" type="button"
                                          class="btn-dpt">Clear Pronunciation Sounds
                                  </button>
                              </div>
                          </form>
                      </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6">
                      <div class="price-dl-box about-box general-shadow">
                          ...
                          <div class="text-center">
                              <img class="logo" src="https://www.clarityenglish.com/images/program/sss/sss-icon.png" />
                          </div>
                      </div>
                  </div>
              </div>
