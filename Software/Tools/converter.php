...
require_once(dirname(__FILE__)."/vo/com/ClarityEnglish/conversion/vo/Hints.php");
require_once(dirname(__FILE__)."/vo/com/ClarityEnglish/conversion/vo/Hint.php");
...
require_once(dirname(__FILE__)."/vo/com/ClarityEnglish/conversion/vo/ModelHint.php");
...
$titleFolder = $contentFolder.'/ActiveReading-International';
$titleFolderOut = $contentFolder.'/../Couloir/ActiveReading-International';
...
//		return;
	...
	switch (strtolower($type)) {
		case 'presentation':
        case 'bullet': //no this type in my canada
		...
		case 'stopgap':
			...
			break;
		case 'dropdown':
        case 'stopdrop': //no this type in my canada
		...
		case 'targetspotting':
		case 'proofreading':
        case 'questionspotter': //no this type in my canada
			$exercise = new TargetSpotting($xml);
			break;
		case 'errorcorrection': //no this type in my canada
