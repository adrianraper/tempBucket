	...
	*/
	...
	public class Reportable implements IUID {
		...
		public function toIDObject():Object {
			...
			do {
				...
				if (reportable is User) {
					reportableObj[ClassUtil.getClassAsString(reportable)] = (reportable as User).userID;
				} else {
					reportableObj[ClassUtil.getClassAsString(reportable)] = reportable.id;
				}
		...
		public function toCaptionObject():Object {
			...
			var reportableObj:Object = new Object();
			do {
				reportableObj[ClassUtil.getClassAsString(reportable)] = reportable.reportableLabel;
				reportable = reportable.parent;
			} while (reportable);
