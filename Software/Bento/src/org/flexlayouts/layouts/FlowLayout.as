	...
	public class FlowLayout extends LayoutBase {
		...
		/*override public function updateDisplayList(containerWidth:Number, containerHeight:Number):void {
			...
			for (var i:int = 0; i < count; i++) {
				...
				element.setLayoutBoundsSize(200, 200);
				
				// The problem with this whole thing is that the preferred size isn't getting set which means that the NaN, NaN call doesn't do anything
			}
		}*/
