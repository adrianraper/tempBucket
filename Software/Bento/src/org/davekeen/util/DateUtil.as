package org.davekeen.util {
	...
	public class DateUtil {
		...
		public static function secondsToHMS(seconds:Number, showHours:Boolean, padMinutes:Boolean = true, seperator:String = null):String {
			...
			return ((showHours) ? StringUtils.padLeft(h.toString(), "0",  2) + seperator : "") + ((padMinutes) ? StringUtils.padLeft(m.toString(), "0", 2) : m.toString()) + seperator + StringUtils.padLeft(s.toString(), "0", 2);
		}
	}
}