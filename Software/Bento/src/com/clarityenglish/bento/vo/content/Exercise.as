package com.clarityenglish.bento.vo.content {
	...
	/**
	 * This will most likely be integrated into the existing Exercise class in RM/DMS
	 * 
	 * @author
	 */
	[Event(name="externalStyleSheetsLoaded", type="com.clarityenglish.bento.events.ExerciseEvent")]
	public class Exercise extends EventDispatcher {
