	...
	public class ExerciseShowPreviousCommand extends SimpleCommand {
		...
		public override function execute(note:INotification):void {
			...
			if (!exerciseProxy.exerciseMarked && exerciseProxy.exerciseDirty) {
				...
				sendNotification(BBNotifications.WARN_DATA_LOSS, {type:"lose_answers", action:"show_previous"});
				...
				sendNotification(BBNotifications.WARN_DATA_LOSS, {type:"feedback_not_seen", action:"show_previous"});
