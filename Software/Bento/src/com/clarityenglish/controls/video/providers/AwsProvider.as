package com.clarityenglish.controls.video.providers {
	...
	public class AwsProvider implements IVideoProvider {
		...
		public function AwsProvider(videoPlayer:IVideoPlayer = null) {
			...
			urlPattern = /rtmp:\/\/streaming\.clarityenglish\.com:1935\/cfx\/st\/([\w\/]+)/i;
			srcPattern = /aws:([\w\/]+)/i;
			urlBase = 'rtmp://streaming.clarityenglish.com:1935/cfx/st/{id}';
			srcBase = 'aws:{id}';
			idPattern = /{id}/i;
		}
		...
		public function create(source:Object):void {
			...
			var filename:String = urlBase.replace(idPattern, getId(source));
