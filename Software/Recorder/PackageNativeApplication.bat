...
set APP_XML=nativeApplication.xml 
...
:: target for native installer
set NATIVE_TARGET=-target native air/ClarityRecorder.exe

echo Signing AIR setup using certificate %CERTIFICATE%.
call adt -package %SIGNING_OPTIONS% %NATIVE_TARGET% %APP_XML% %FILE_OR_DIR% 
