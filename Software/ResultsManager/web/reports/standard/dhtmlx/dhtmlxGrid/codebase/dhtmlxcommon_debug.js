		...
		this.check=function (){
			if ((dhtmlObject)&&(dhtmlObject.onloadAction!=null)){
				if  ((!dhtmlObject.xmlDoc.readyState)||(dhtmlObject.xmlDoc.readyState == 4)){
					...
					log="Loading: "+dhtmlObject.filePath+"\nStatus: "+dhtmlObject.xmlDoc.status;
					if (_isIE) log+="\nError: "+dhtmlObject.xmlDoc.responseXML.parseError.reason+"\nXML: "+(!!dhtmlObject.xmlDoc.responseXML.firstChild);
					else log+="\nXML: "+(!((!dhtmlObject.xmlDoc.responseXML.firstChild) || dhtmlObject.xmlDoc.responseXML.firstChild.tagName.indexOf("parsererror")!=-1));
