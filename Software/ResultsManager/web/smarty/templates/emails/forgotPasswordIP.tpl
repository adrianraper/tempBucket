...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>IELTSpractice - password reset</title>
        <style type="text/css">
...
<div style="width:600px;">
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
       ...
       <p style="margin: 0 0 10px 0;">This link will expire in 24 hours from when this email was generated. If you need a new link, go back to <a href="https://www.IELTSpractice.com/login.php" target="_blank">www.IELTSpractice.com</a> and click 'Forgot password' again.</p>
      
        <p style="margin: 0 0 10px 0;">Regards,<br/>
		Henry Wong</p>
		{include file='file:includes/IPSupport_Email_Signature.tpl'}
    </div>
</div>
</body>
</html>