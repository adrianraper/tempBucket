    ...
    <td colspan="3">
        ...
        <tr>
        	<td height="53" colspan="3" background="http://www.clarityenglish.com/images/email/ieltspractice/subtitle.jpg">
            	<p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0; padding:0 48px; color:#FFFFFF; line-height:53px; font-weight:bold;">Welcome to TB6weeks</p>                </td>
        </tr>
  ...
  <tr>
    <td colspan="3">
	  ...
	  <div style="padding:0 48px;">
           		...
           		<p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Dear jake</p>
