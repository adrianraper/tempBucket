{* Name: R2iV2 BC China registration welcome *}
{* Parameters: $user *}
{assign var='prefix' value='GLOBAL'}
{if $productCode==12 || $productCode==52} 
...
<a href="http://www.roadtoielts.com/email/welcome-ielts-china-lastmin.php?prefix={$prefix}&module={$module}&studentID={$studentID}&email={$email}&password={$password}" target="_blank">http://www.roadtoielts.com/email/welcome-ielts-china-lastmin.php</a></div>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; color:#333333; font-size:14px; min-width:600px; line-height:16px;" background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-bg.jpg">
  ...
  <tr>
    <td width="41"></td>
    <td width="515"><div style="margin:12px 8px; line-height:1.4em;">
Dear {$name} / 您好!</div>
<div style="margin:0 8px 12px 8px; line-height:1.4em;">
感谢您激活你的「雅思之路(冲刺版)」帳戶。「雅思之路」是由英国文化教育协会雅思专家设计的在线 准备课程，课程包含听力、阅读、 写作和口语。 请点击下方登录開始練習。
</div>
...
<div style="margin:0 8px 12px 8px; line-height:1.4em;">Welcome to the Road to IELTS online preparation platform. Road to IELTS is designed to help you get the best possible band score in IELTS. Read the instructions below to sign in to your account and start accessing exercises, practice tests and videos designed by IELTS examiners and experts.</div>
		...
		<table width="505" border="0" cellspacing="0" cellpadding="0" background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-table-bg.jpg"  style="font-family:Arial, Helvetica, sans-serif; color:#333333; font-size:14px; margin-bottom:10px;">
          <tr>
            <td background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-table-top.jpg" height="35" valign="middle" align="center" bgcolor="#00426B" style="padding-top:8px;">
            	<img src="http://www.clarityenglish.com/images/email/rti2/ico-desktop.png"  style="vertical-align:middle; margin-right:5px;"/><span style="margin-left:5px; color:#FFFFFF; font-weight:bold;">Starting the laptop/desktop version (笔记本/台式机)</span>
          ...
          <tr> 
            <td background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-table-bg.jpg" >
            	<div style="padding:10px 40px; color:#333333; line-height:1.4em; font-family:Arial, Helvetica, sans-serif; font-size:1em;">
                	<strong>您的登录详细信息 / Your sign in details:</strong><br />
                    登录 ID / login ID: {$studentID}<br />
                    密码 / password: {$password}                 </div>
        ...
        <table width="505" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; color:#333333; font-size:14px; line-height:16px;"  background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-table-bg.jpg">
          <tr>
            <td height="35" colspan="4" align="center" valign="middle" background="http://www.clarityenglish.com/images/email/rti2/ielts-lm-table-top.jpg" bgcolor="#00426B" style="padding-top:8px;">
            	<img src="http://www.clarityenglish.com/images/email/rti2/ico-tablet.png"  style="vertical-align:middle; margin-right:5px;"/><span style="margin-left:5px;  color:#FFFFFF; font-weight:bold;">Starting the tablet version* (平板电脑)</span>            </td>
          </tr>
          <tr> 
           ...
           <tr> 
            <td height="16" colspan="4">
             ...
             <tr > 
            <td width="40"></td>
            <td width="268" style="color:#333333; line-height:1.2em; font-family:Arial, Helvetica, sans-serif; font-size:0.9em;">
             <div style="padding:0 10px 5px 0;">*您必须首先从苹果App Store或Google Play商店下载应用程序和安装到您的平板电脑上。</div>
            <div style="padding-right:10px;">*First download the app from the App Store or Google Play Store and install the app onto your tablet.</div></td>
            <td width="182" align="left">
                ...
                <a href="https://play.google.com/store/apps/details?id=air.com.clarityenglish.ielts.app" target="_blank" style=" font-size:0.9em;"><img src="http://www.clarityenglish.com/images/email/rti2/ielts-lm-google-play.jpg" alt="Google play" width="79" height="27" border="0"/></a>
                
                <a href="http://roadtoielts.chinaielts.org/downloads/apk/RoadToIELTS.php?utm_campaign=APP-APK&utm_source=RTI&utm_medium=Email-BCChina-LM" target="_blank" style=" font-size:0.9em;"><img src="http://www.clarityenglish.com/images/email/rti2/clarity-lm-app.jpg" alt="App store" width="90" height="27" border="0"/></a>
    	...
    	<div style="margin:12px 8px; line-height:1.4em;">如您在使用雅思之路时如有任何问题 请您电邮至 <a href="mailto:support@roadtoielts.com">support@roadtoielts.com</a> 。</div>
...
<div style="margin:0 8px; line-height:1.4em;">祝您雅思考取佳绩！</div>
