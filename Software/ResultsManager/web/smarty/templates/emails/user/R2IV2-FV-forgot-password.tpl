...
<div style="margin:0; padding:0;">
    ...
    <div style="width:300px; float:right; padding:10px 0 10px 0;">
        ...
        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:5px 0 5px 0; padding:0; color:#000000; line-height:18px;">Dear {$user->name},</p>
             ...
             <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><a href="http://www.roadtoielts.com/BritishCouncil/Registration/login.php?loginID={$user->studentID}" target="_blank">www.roadtoielts.com/BritishCouncil/Registration/</a></p>
