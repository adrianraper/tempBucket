{* Name: R2iV2 BC ORS welcome *}
{* Description: Email sent when you have first clicked Road to IELTS 2 from ORS *}
{* Parameters: $user *}
...
<div style="margin:0; padding:0;">
    ...
    <div style="width:300px; float:right; padding:10px 0 10px 0;">
        ...
        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">Dear candidate,</p>
             ...
             <a href="https://ielts.britishcouncil.org/R2IHome.aspx" target="_blank" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;"><img src="http://www.clarityenglish.com/images/email/rti2/btn_welcome_eng.jpg" width="225" height="45"  border="0" style="display:block; margin:10px 0;" alt="Start using Road to IELTS now"/></a>
             <p style="font-family:  Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">Course link: <a href="https://ielts.britishcouncil.org/R2IHome.aspx" target="_blank">ielts.britishcouncil.org</a></p>
             <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">We hope you will find the training useful and the site easy to use. Please contact us at <a href="mailto:examinations@britishcouncil.org?subject=New Road to IELTS enquiry">examinations@britishcouncil.org</a> if you have any comments or queries regarding the new platform.</p>
            <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">Have fun with the exercises and good luck with your IELTS test!</p>
