...
<div style="margin:0; padding:0;">
    ...
    <div style="width:300px; float:right; padding:10px 0 10px 0;">
        ...
        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:5px 0 5px 0; padding:0; color:#000000; line-height:18px;">Dear {$user->name},</p>
             ...
             <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><a href="http://www.roadtoielts.com/britishcouncil/korea/ebs" target="_blank">www.roadtoielts.com/britishcouncil/korea/ebs</a></p>
			<div style="margin:10px 50px 30px 10px; padding:0; background-color:#CCCCCC; ">
             ...
             <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; padding:0 0 10px 0; margin:0 20px 5px 20px; line-height:18px; ">Expiry date: {$user->expiryDate|date_format:"%Y-%m-%d"}</p>
			</div>
             ...
             <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:10px  0 5px 0; padding:0; color:#000000; line-height:18px;">Please do <a href="mailto:support@roadtoielts.com?subject=Road to IELTS enquiry (Korea EBS)">contact us</a> if you have any queries.</p>
  ...
  <tr>
    <td width="425" height="50" valign="top" nowrap="nowrap" background="http://www.clarityenglish.com/images/email/rti2/welcome_foot_bg.jpg" >
        ...
        <div style="padding:0 0 0 30px; margin:0; line-height:40px; color:#FFFFFF;">
            ...
            <a href="https://reg.britishcouncil.kr" target="_blank" style="color:#FFFFFF; text-decoration:none; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; ">https://reg.britishcouncil.kr</a>        </div>
