...
<html>
	<head>
		...
		<title>Forgot Password - Road to IELTS 2</title>
...
<table style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;" border="0" cellpadding="0" cellspacing="0" width="600" >
  ...
  <tr align="left" valign="top">
	...
	URL: <a href="http://www.roadtoielts.com/BritishCouncil/China/login.php?loginID={$user->studentID}">www.roadtoielts.com/BritishCouncil/China</a><br/>
