...
<div style="margin:0; padding:0;">
    ...
    <div style="width:300px; float:right; padding:10px 0 10px 0;">
   	  ...
   	  <div style="margin:0; padding:0;">
        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:5px 0 5px 0; padding:0; color:#000000; line-height:18px;">Dear candidate,</p>
             ...
             <p style="font-family: Verdana, 新細明體, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><a href="http://www.roadtoielts.com/BritishCouncil/R2IV2/login.php" target="_blank">www.roadtoielts.com/BritishCouncil/R2IV2/</a></p>
			<div style="margin:10px 50px 30px 10px; padding:0; background-color:#999999; ">
             <p style="font-family: Verdana, 新細明體, Arial, Helvetica, sans-serif; font-size: 12px; padding:10px 0 0 0; margin:10px 20px 5px 20px; color:#000000; line-height:18px; ">Login ID: 1111-1111-1111</p>
             <p style="font-family: Verdana, 新細明體, Arial, Helvetica, sans-serif; font-size: 12px; padding:0 0 10px 0; margin:0 20px 5px 20px; line-height:18px; ">Password: secret</p>
			</div>
             <a href="http://www.roadtoielts.com/BritishCouncil/R2IV2/login.php" target="_blank" style="font-family: Verdana, 新細明體, Arial, Helvetica, sans-serif; font-size: 12px;"><img src="http://www.clarityenglish.com/images/email/rti2/btn_welcome_eng.jpg" width="225" height="45"  border="0" style="display:block; margin:10px 0;" alt="Start using Road to IELTS now"/></a>
