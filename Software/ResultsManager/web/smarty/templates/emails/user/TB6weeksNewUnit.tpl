...
<head>
    ...
    <title>{if $weekX==1}TB6weeks - Your new subscription{elseif $weekX>6}TB6weeks - Complete!{else}TB6weeks - your new unit{/if}</title>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F1F1F1" style="font-size:12px; min-width:600px;">
  <tr>
    ...
    <td colspan="3" background="http://www.clarityenglish.com/TenseBuster/6weeks/images/email/bar-grey.jpg">
        <table width="600" border="0" cellspacing="0" cellpadding="0" height="73" style="font-size:12px; min-width:600px;">
          <tr>
            ...
            <td width="128" style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 1.8em; line-height:73px; color:#E22634;">{$levelDescription}</td>
  ...
  <tr>
    <td colspan="3" background="http://www.clarityenglish.com/TenseBuster/6weeks/images/email/bg-foot.jpg" height="174" valign="top">
    	<table width="600" border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;">
          <tr>
            <td width="218">
            	<div style="padding:0 0 20px 34px; color:#333333; font-size:1.2em;">Enjoy your practice!</div>
                <div style="padding:0 0 5px 34px; color:#333333; font-size:1.2em;">Best Wishes</div>
                <div style="padding:0 0 0 34px; color:#333333; font-size:1.2em;"><img src="http://www.clarityenglish.com/TenseBuster/6weeks/images/email/ClarityEnglish.png" /></div>
            </td>
            <td width="382"><a href="#" target="_blank"><img src="http://www.clarityenglish.com/TenseBuster/6weeks/images/email/TB-DownloadApps.png" border="0"/></a></td>
          </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="3"  height="28" bgcolor="#333333"><img src="http://www.clarityenglish.com/TenseBuster/6weeks/images/email/clarityenglish-line.jpg" /></td>
  </tr>
</table>
