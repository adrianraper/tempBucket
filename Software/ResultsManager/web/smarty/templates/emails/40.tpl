...
<head>
	...
	<title>Clarity English - expires tomorrow</title>
...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 10px 0; padding:0; color:#000000;">Just a quick note to remind you that your Clarity English subscription expires <strong>tomorrow</strong>. I would hate for there to be an interruption to your service, so if you intend to renew, please send me an email and I’ll arrange for a two-week extension, free of charge.</p>
<!--
