...
<html>
	<head>
		...
		<title>A new version of Road to IELTS is coming</title>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="3">
		...
		<p style="background-color:#F3C516; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">If you have already contacted us, please ignore this email. Otherwise you will be switched to the new Road to IELTS in seven days if you take no action.</p>
             ...
             <tr>
              <td valign="top">
                    <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0; padding:0; color:#000000; line-height:18px;"><strong>What happens to my direct links?</strong></p>
                        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">If you use a direct URL to link to Road to IELTS, this will change.<br/> 
			{if $multipleTitles=='true'}
				Your new direct links are (and they will be active in a few days):</p>
			{else}
				Your new direct link is (and it will be active in a few days):</p>
			{/if}
			
{foreach name=orderDetails from=$account->titles item=title}
{if $title->productCode==12}
	<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; margin:0 0 5px 0; padding:0; color:#000000; line-height:14px;">www.clarityenglish.com/area1/RoadtoIELTS2/Start-AC.php?prefix={$account->prefix}</p>
{/if}
{if $title->productCode==13}
	<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; margin:0 0 5px 0; padding:0; color:#000000; line-height:14px;">www.clarityenglish.com/area1/RoadtoIELTS2/Start-GT.php?prefix={$account->prefix}</p>
{/if}
{/foreach}
			</p>
							
                        <p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">If you follow the old direct link, this will redirect to the new one for a while, but we recommend that you change it as soon as convenient.
			</p>				
		</td>
              <td valign="top">
