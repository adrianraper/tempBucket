...
Please keep this email for later reference.</p>
        ...
        <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 14px; margin:0 0 5px 0; padding:0; color:#0399D6; font-weight:bold;line-height:18px;">Pay by Direct Bank Deposit</p>
                ...
                <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">
                ...
                <ol style="margin:0; padding:0 0 0 25px; list-style-type: lower-roman;  line-height:18px;">
                  ...
                  <li>Quote the  reference number at the top of this email</li>
               		...
               		<p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Please feel free to contact us if you have any questions.</p>
                        ...
                        <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; margin:15px 0; padding:0; color:#000000; line-height:18px;"><img src="http://www.clarityenglish.com/images/email/ieltspractice/sign_christianng.jpg" width="103" height="25" alt="Adrian Raper"/></p>
  ...
  <tr>
       ...
       <div style="padding:20px 48px;">
            ...
            E: <a href="mailto:info@clarityenglish.com" style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; color:#FFFFFF;">info@clarityenglish.com </a>| W: <a href="http://www.clarityenglish.com" target="_blank" style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; color:#FFFFFF;">www.ClarityEnglish.com</a></p> 
               ...
               <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 13px; 0; padding:0; color:#FFFFFF; line-height:18px;">
