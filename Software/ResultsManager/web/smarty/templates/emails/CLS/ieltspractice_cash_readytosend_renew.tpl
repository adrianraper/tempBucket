  ...
  <tr>
    <td colspan="3">
	  ...
	  <div style="padding:0 48px; margin:0;">
        ...
        <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Thank you for your interest in renewing your IELTSpractice.com subscription! Please follow the steps below to make payment. Your account will be extended in ONE working day, once the payment has been confirmed.</p>
...
<li style="margin:0; padding:0;">Click <a href="http://www.clarityenglish.com/images/email/ieltspractice/WesternUnionSample_Clarity_Brian.jpg" target="_blank">here</a> to see a sample</li>
  ...
  <tr>
    ...
    <td align="left" valign="top" background="http://www.clarityenglish.com/images/email/ieltspractice/list_top_bg.jpg">
    	<p style="padding:8px 0 0 0; margin:0;">5.</p>    </td>
