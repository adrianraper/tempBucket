...
<title>IELTSpractice - Your new account ({$api->subscription->id}/{$api->paymentRef})</title>
	  ...
	  <div style="padding:0 48px;">
        ...
        <div style="border:#CCCCCC 1px solid; padding:10px; margin:0 0 15px 0;">
            ...
            <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">
            	<strong>Email: </strong>{$api->subscription->email}</p>
            <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;">
...
Please keep this email for later reference.</p>
  ...
  <tr>
    <td colspan="2"><p style="margin:0 0 5px 0; padding:0;"><strong>Expires on: </strong>{format_ansi_date ansiDate=$api->subscription->expiryDate format='%d %B %Y'}</p></td>
    </tr>
  <tr>
    ...
    <td colspan="2"><p style="margin:0 0 5px 0; padding:0;"><strong>Reference number: </strong>{$api->subscription->id}/{$api->paymentRef}</p></td>
        ...
        <div  style="margin:0 0 20px 0; padding:0;">
          <p style="font-family: Arial, Verdana,  Helvetica, sans-serif; font-size: 12px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px; font-weight:bold;">Using an iPad or tablet? Download our app here. It's free!</p>
             ...
             <a href="https://itunes.apple.com/us/app/road-to-ielts/id560055517?mt=8&ign-mpt=uo%3D4" target="_blank" ><img src="http://www.clarityenglish.com/images/email/ieltspractice/badge_appstore.png" border="0" width="135" height="40" style="margin:0 5px 0 0;" /></a>
             <a href="https://play.google.com/store/apps/details?id=air.com.clarityenglish.ielts.app" target="_blank"><img src="http://www.clarityenglish.com/images/email/ieltspractice/badge_googleplay.png" border="0" width="117" height="40"  style="margin:0 5px 0 0;"/></a>
              <a href="http://www.clarityenglish.com/downloads/apk/RoadToIELTS.php?utm_campaign=APP-APK&utm_source=RTI&utm_medium=IP-Welcome-Email" target="_blank"><img src="http://www.clarityenglish.com/images/email/ieltspractice/badge_cestore.png" border="0" width="117" height="40" /></a>
  ...
  <tr>
    ...
    <table width="600" height="219" border="0" cellpadding="0" cellspacing="0" background="http://www.clarityenglish.com/images/email/ieltspractice/img_btm_study.jpg">
                    <tr>
                 	...
                 	Cynthia Lau<br />
                    IELTSpractice Support Team</p>                   </td>
