...
<li style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 1em; line-height:18px;margin:0 0 5px 0; color:#151745; font-weight:700;">The functions of your Administrator account</li>
	<div style="background-color:#E8E3F0;  padding:10px 20px; margin:0 auto 10px auto;">
     ...
     {if $hasAARM==true}
	<p style="font-family:  Arial, Helvetica, sans-serif;  font-size: 1em; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Note that you should restrict access to the Administrator account to a single person. 
...
<p style="font-family:  Arial, Helvetica, sans-serif; font-size: 1em; line-height:18px;margin:0 0 10px 0;">First sign in at <a href="http://www.clarityenglish.com?utm_source=auto_email&utm_medium=edu_acct_add&utm_term=link_home&utm_campaign=auto_welcome&utm_content=1st_ce_home" target="_blank">www.ClarityEnglish.com</a>, using your Administrator account. In order to activate the programs, the first thing you need to do is to accept the terms and conditions, which  will automatically be shown to you.</p>


{if $hasAARM==true}
	<p style="font-family:  Arial, Helvetica, sans-serif;  font-size: 1em; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Once you have done this, you and your learners will have full access to your ClarityEnglish programs.</p>
{else}
	<p style="font-family:  Arial, Helvetica, sans-serif; font-size: 1em; line-height:18px;margin:0 0 10px 0;">Once you have done this, click on the Results Manager icon. This is where you add groups, learners and teachers. Click <a href="http://www.clarityenglish.com/Software/ResultsManager/web/Help/Results%20Manager%20Guide.pdf" target="_blank">here</a> to read the User Guide.</p>
{/if}
...
{else}
	<p style="font-family:  Arial, Helvetica, sans-serif;  font-size: 1em; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Learners can access your ClarityEnglish programs from <a href="http://www.clarityenglish.com?utm_source=auto_email&utm_medium=edu_acct_add&utm_term=link_home&utm_campaign=auto_welcome&utm_content=1st_ce_signin" target="_blank">www.clarityenglish.com</a>. 
...
<a href="http://www.clarityenglish.com/resources/?utm_source=auto_email&utm_medium=edu_acct_add&utm_term=link_resources&utm_campaign=auto_welcome&utm_content=welcome_promote" target="_blank">http://www.clarityenglish.com/resources/</a></p>
