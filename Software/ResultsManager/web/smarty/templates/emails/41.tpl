...
{if $useWording == 'all'}
	Your ClarityEnglish subscription expires today. Your learners no longer have access to the programs listed below. 
...
{elseif $useWording == 'one'}
	One program in your ClarityEnglish subscription expires today. Your learners no longer have access to the program highlighted below. 
...
{elseif $useWording == 'couple'}
	Two programs in your ClarityEnglish subscription expire today. Your learners no longer have access to the programs highlighted below. 
...
{else}
	Some programs in your ClarityEnglish subscription expire today. Your learners no longer have access to the programs highlighted below.
	As I mentioned in yesterday's email, if you do intend to renew, please send me an email and I'll arrange for a two-week extension, free of charge, while we renew the programs.
{/if}
