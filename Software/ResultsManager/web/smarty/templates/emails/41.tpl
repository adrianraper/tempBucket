...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 10px 0; padding:0; color:#000000;">Your Clarity English subscription expires today. Your learners no longer have access to the programs listed below. As I mentioned in yesterday’s email, if you do intend to renew, please send me an email and I’ll arrange for a two-week extension, free of charge, while we renew the account.</p>
<!--
