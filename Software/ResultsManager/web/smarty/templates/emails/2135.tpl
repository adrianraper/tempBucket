...
<title>It's Your Job - Overcome your fear of difficult interview questions</title>
</head>
...
<table style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;" width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td background="http://www.clarityenglish.com/itsyourjob/images/email/header2.jpg" colspan="5" height="60"  valign="bottom">
        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-size:12px; font-weight:bold;">Unit 5</span></td>
          </tr>
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:18px;">Handling difficult questions</span></td>
          </tr>
          <tr>
            <td width="25"></td>
          ...
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:14px;">Overcome your fear of difficult interview questions</span></td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <td width="435" rowspan="2" valign="top">
        ...
        <p style="margin: 0 0 10px 0; padding:0;">Are you nervous about the kind of questions you may be asked in the interview? How would you answer these:<br />
"How would you rate me as an interviewer?"<br />
"If you were an animal, what would you be?"
</p>
         <p style="margin: 0 0 10px 0; padding:0;">In Unit 5, you will learn how to prepare for three types of interview question: questions based on the job ad; questions based on your resume; and off-the-wall questions like the ones above.</p>
    ...
    <td width="105" valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;">
          ...
          <tr>
            <td style="color:#1B1464;">Effective follow-up</td>
          </tr>
          <tr>
            <td height="5"></td>
          </tr>
          <tr>
            <td style="font-size:9px">The interview process is not complete until you sign on the dotted line. Job-seekers who follow up after interviews increase their chances of being hired. In the next unit, we'll look at the follow-up work you should do after the interview. And we'll guide you through the minefield of salary negotiation.</td>
          </tr>
