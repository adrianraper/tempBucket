...
{include file="file:includes/expiringTitles_2.tpl" assign=useWording}
...
{if $useWording == 'all'}
	your Clarity English subscription expires
{elseif $useWording == 'one'}
...
-->
	...
	{include file='file:includes/Title_Details_Section_2.tpl' dateDiff=$dateDiff useWording=$useWording}
<!-- 
-- Email footer
-->
