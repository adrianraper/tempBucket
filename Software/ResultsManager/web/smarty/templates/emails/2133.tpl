...
<title>It's Your Job - Making your cover letters irresistible</title>
</head>
...
<table style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;" width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td background="http://www.clarityenglish.com/itsyourjob/images/email/header2.jpg" colspan="5" height="60"  valign="bottom">
        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-size:12px; font-weight:bold;">Unit 3</span></td>
          </tr>
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:18px;">Cover letters that work</span></td>
          </tr>
          <tr>
            <td width="25"></td>
          ...
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:14px;">Making your cover letters irresistible</span></td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <td width="435" rowspan="2" valign="top">
		...
		<p style="margin: 0 0 10px 0; padding:0;">Any experienced recruiter can detect when a cover letter originated from a template downloaded from the Internet. And they don't like it. You need to make your cover letter work for you, not against you.</p>
		<p style="margin: 0 0 10px 0; padding:0;">In Unit 3, you will learn what to include in you cover letter, how long it should be and how to adapt it for each position you are applying for.</p>
    ...
    <td width="105" valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;">
          ...
          <tr>
            <td style="color:#1B1464;">Prepare for the interview</td>
          </tr>
          <tr>
            <td height="5"></td>
          </tr>
          <tr>
            <td style="font-size:9px">Many people view job interviews with dread. In the next unit, we will look at what you should expect from employers at interviews and what they expect from you. We will explore how proper preparation will enable you to give the best possible performance.</td>
          </tr>
