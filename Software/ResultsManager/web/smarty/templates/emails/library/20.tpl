...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; margin: 0 0 10px 0; font-size: 12px; padding:0; color:#000000;">Dear Librarian</p>
        ...
        <div style="background-color:#EBEBEB; width:450px; padding:10px 20px 10px 20px; margin:0 0 10px 0;">
        	<span style="font-family: Verdana, Arial, Helvetica, sans-serif; margin: 0 0 10px 0; font-size: 12px; padding:0; color:#000000;"><a href="http://www.ClarityEnglish.com" style="color:#003366; font-weight:700;" target='_blank'>www.ClarityEnglish.com</a></span>
