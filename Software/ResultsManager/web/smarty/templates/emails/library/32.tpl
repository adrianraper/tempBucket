...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:0 auto; padding:10px 50px 20px 50px;">
      ...
      <p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 5px 0; padding:0; color:#151745; font-weight:700;">ClarityEnglish Subscription: {$account->name}</p>
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">You may also find it useful to visit the Clarity Support site, where there are a number of support resources, including posters, videos, web images, screenshots, and more. <br /><a href='http://www.clarityenglish.com/resources/?utm_source=auto_email&utm_medium=lib_32&utm_campaign=auto_welcome&utm_term=link_resources' target='_blank'>www.ClarityEnglish.com/resources/</a></p>
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Meanwhile, don't forget that if you have any queries, difficulties, requests or feedback, you are very welcome to contact either your Account Manager or me at any time.</p>
