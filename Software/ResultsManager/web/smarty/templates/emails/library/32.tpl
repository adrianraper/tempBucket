...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">You may also find it useful to visit the Clarity Support site: <a href='http://www.clarityenglish.com/lib/resources/' target='_blank'>www.clarityenglish.com/lib/resources/</a></p>
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">You will find a member of support resouces, including posters, videos, web images, screenshots, and more.</p>
