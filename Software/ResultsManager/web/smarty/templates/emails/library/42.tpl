...
<div style="width:600px; margin:0 auto; padding:0;">
	...
	<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">If you'd like to renew, just send me a quick email and we can have your program up and running within one working day. 
...
-- Email signature 
-->
	<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:10px 0 10px 0; padding:0; color:#000000;">I look forward to hearing from you.</p>
