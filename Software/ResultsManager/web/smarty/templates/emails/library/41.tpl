...
{if $useWording == 'all'}
	<title>ClarityEnglish - Your account expires today</title>
{elseif $useWording == 'one'}
	<title>ClarityEnglish - One program in your account expires today</title>
{elseif $useWording == 'couple'}
	<title>ClarityEnglish - Two programs in your account expire today</title>
{else}
	<title>ClarityEnglish - Some programs in your account expire today</title>
{/if}
...
<div style="width:600px; margin:0 auto; padding:0;">
      <img src="http://www.clarityenglish.com/images/email/header_600_img.jpg" alt="ClarityEnglish - Your account expires today" style="border:0; margin:0; text-align:center; font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-weight:400; font-size: 13px;">
...
{if $useWording == 'all'}
	Your ClarityEnglish subscription expires <strong>today</strong>. Your library members no longer have access to the programs listed below. 
...
{elseif $useWording == 'one'}
	One program in your ClarityEnglish subscription expires <strong>today</strong>. Your library members no longer have access to the program highlighted below. 
...
{elseif $useWording == 'couple'}
	Two programs in your ClarityEnglish subscription expire <strong>today</strong>. Your library members no longer have access to the programs highlighted below. 
...
{else}
	Some programs in your ClarityEnglish subscription expire <strong>today</strong>. Your library members no longer have access to the programs highlighted below.
	As I mentioned in yesterday's email, if you do intend to renew, please send me an email and I'll arrange for a two-week extension, free of charge, while we renew the programs.
{/if}
