...
<div style="width:600px; margin:0 auto; padding:0;">
      ...
      <img src="http://www.clarityenglish.com/images/email/header_600_img.jpg" alt="Clarity English - Feedback" style="border:0; margin:0; text-align:center; font-family: 'Oxygen', Arial, Helvetica, sans-serif;  line-height:18px; font-weight:400; font-size: 13px;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">I wanted to take this opportunity to invite you to fill in a quick questionnaire. It shouldn't take more than ten minutes, and the objective is to enable us to enhance the service we are providing to you.  If you'd like to do this, please <a href="http://www.clarityenglish.com/questionnaire/cefeedback.php" target="_blank">click</a> here.</p>
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Incidentally, you might be interested to know that we are constantly improving the online support for all our programs. To find out more click <a href='http://www.clarityenglish.com/support' target='_blank'>here</a>.</p>
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">As ever, if you have any queries or requests, please get in touch.</p>
