...
<head>
	...
	<title>ClarityEnglish - ICT support for librarians</title>
...
<div style="width:600px; margin:0 auto; padding:0;">
  <img src="http://www.clarityenglish.com/images/email/header_600_img.jpg" alt="ClarityEnglish - ICT support for librarians" style="border:0; margin:0; text-align:center; font-family: 'Oxygen', Arial, Helvetica, sans-serif;   font-weight:400; font-size: 13px;">
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
      ...
      <p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 5px 0; padding:0; color:#151745; font-weight:700;">ClarityEnglish Subscription: {$account->name}</p>
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">I hope your ClarityEnglish resources are proving really popular, and that your library members are enjoying them.</p>
        ...
        we have various resources to help increase usage? For example, you might be interested in using materials on the <a href='http://www.clarityenglish.com/resources/?utm_source=auto_email&utm_medium=lib_34&utm_campaign=auto_stat&utm_term=link_resources' target='_blank'>Clarity Support site</a> to publicise the programs within your library. These include videos, posters, flyers, web graphics and so on. Most of these items are free to subscribers. </p>
