...
<div style="width:600px; margin:0 auto; padding:0;">
		<img src="http://www.clarityenglish.com/images/email/header_600_img.jpg" alt="ClarityEnglish - Subscription reminder" style="border:0; margin:0; text-align:center; font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-weight:400; font-size: 13px;">
...
{if $useWording == 'all'}
	your ClarityEnglish subscription has  
{elseif $useWording == 'one'}
	one program in your ClarityEnglish subscription has 
{elseif $useWording == 'couple'}
	two programs in your ClarityEnglish subscription have 
{else}
	some programs in your ClarityEnglish subscription have 
{/if}
		just 45 days left to run. We wouldn't like you to miss out on your Clarity programs, which is why we are giving you plenty of notice.</p>
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-weight:400; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">If you'd like to renew, or if you have any queries about renewal, please contact your Account Manager.
