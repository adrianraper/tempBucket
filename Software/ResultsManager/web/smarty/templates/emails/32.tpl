...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:0 auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-weight:400; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">You may also find it useful to visit the Clarity Support site: <a href='http://www.ClarityEnglish.com/support' target='_blank'>www.ClarityEnglish.com/support</a></p>
		...
		<p style="font-family: 'Oxygen', Arial, Helvetica, sans-serif; font-weight:400; font-size: 13px; line-height:18px; margin:0 0 10px 0; padding:0; color:#000000;">Meanwhile, don't forget that if you have any queries, difficulties, requests or feedback, you are very welcome to contact me at any time.</p>
