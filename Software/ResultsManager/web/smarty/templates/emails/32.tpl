...
<div style="width:600px; margin:0 auto; padding:0;">
    ...
    <div style="width:500px; margin:a auto; padding:10px 50px 20px 50px;">
		...
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 10px 0; padding:0; color:#000000;">You may also find it useful to visit the Clarity Support site: <a href='http://www.ClarityEnglish.com/support' target='_blank'>www.ClarityEnglish.com/support</a></p>
		<p style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; margin:0 0 10px 0; padding:0; color:#000000;">You will find the syllabus for each Clarity program as well as handy activities to help teachers familiarise themselves with the programs.</p>
