...
<title>It's Your Job - What makes a perfect resume?</title>
</head>
...
<table style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;" width="600" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td background="http://www.clarityenglish.com/itsyourjob/images/email/header2.jpg" colspan="5" height="60"  valign="bottom">
        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-size:12px; font-weight:bold;">Unit 2</span></td>
          </tr>
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:18px;">The perfect resume</span></td>
          </tr>
          <tr>
            <td width="25"></td>
          ...
          <tr>
            <td width="25"></td>
            <td width="575" colspan="2"><span style="color:#1B1464; font-weight:bold; font-size:14px;">What makes a perfect resume?</span></td>
          </tr>
        </table>
  ...
  <tr>
    ...
    <td width="435" rowspan="2" valign="top">
        ...
        <p style="margin: 0 0 10px 0; padding:0;">After submitting your resume to an employer, have you ever wondered how it is processed? In Unit 2 of It's Your Job, employers explain what they are looking for in a resume, and how they choose the candidates they will invite for interview. </p>
         <p style="margin: 0 0 10px 0; padding:0;">Use this unit to learn how to put together a resume that is clear, concise, complete, correct - and eye-catching!</p>
{include file='file:includes/IYJ_Email_Signature.tpl'}
    ...
    <td width="105" valign="top">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 11px; color:#000000;">
          ...
          <tr>
            <td style="color:#1B1464;">Cover letters that work</td>
          </tr>
          <tr>
            <td height="5"></td>
          </tr>
          <tr>
            <td style="font-size:9px">Your cover letter can make or break your job application. In the next unit we'll look at how you can put together a cover letter that an employer will find irresistible. And you'll learn how to avoid the mistakes that can send your application straight to the NO pile.</td>
          </tr>
