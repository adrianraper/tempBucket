...
<div style="padding:30px 8% 20px 8%;">
        ...
        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 1em; line-height:18px;margin:0 0 5px 0;color:#151745; font-weight:700;">Updated Account: {$account->name}</p>
		<p style="font-family: Arial, Helvetica, sans-serif;font-size: 1em; line-height:18px;margin:0 0 10px 0;">This email is to confirm that your ClarityEnglish account has been updated. It deals with the technical and administrative aspects of your account, so please keep it in a safe place, as you may want to refer to it later.</p>
        	...
        	<ol style="font-family: Arial, Helvetica, sans-serif;font-size: 1em; line-height:18px; margin:0; padding: 0 0 0 20px;  color:#000000;">
                ...
                <li>Setting up a direct link to your ClarityEnglish programs</li>
                 ...
                 <li>Tense Buster 6-week grammar course</li>
                 	...
                 	{/if}{if $hasR2I=='true' || $hasTBv10=='true' ||  $hasARv10=='true' ||  $hasCP1v10=='true'}
...
Please click <a href="http://www.clarityenglish.com/resources/?utm_source=auto_email&utm_medium=lib_acct_update&utm_campaign=auto_welcome&utm_term=link_resources&utm_content=welcome_promote" target="_blank">here</a> to download web images, including banners and buttons.
...
<a href="http://www.clarityenglish.com/resources/?utm_source=auto_email&utm_medium=lib_acct_update&utm_campaign=auto_welcome&utm_term=link_resources&utm_content=welcome_promote" target="_blank">http://www.ClarityEnglish.com/resources/</a></p>
