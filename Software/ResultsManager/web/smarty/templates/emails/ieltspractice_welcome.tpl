    ...
    <td colspan="3">
        ...
        <tr>
        	<td height="53" colspan="3" background="http://www.clarityenglish.com/images/email/ieltspractice/subtitle.jpg">
            	<p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0; padding:0 48px; color:#FFFFFF; line-height:53px; font-weight:bold;">Welcome to IELTSpractice.com</p>                </td>
        </tr>
  ...
  <tr>
    <td colspan="3">
	  ...
	  <div style="padding:0 48px;">
           		...
           		<p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Dear {$api->subscription->name}</p>
           
        <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">An account has been created for you. To access the account, please go to this URL:
        <a href="http://www.ieltspractice.com" target="_blank">www.IELTSpractice.com</a>.</p>
        
        <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Your login details as below:</p>
        ...
        <div style="border:#CCCCCC 1px solid; padding:10px; margin:0 0 15px 0;">
            ...
            <img src="http://www.clarityenglish.com/images/email/ieltspractice/btn_learn.jpg" width="190" height="42" border="0" />
        	 ...
        	 <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Below are the details you  entered while registering at IELTSpractice.com.
Please keep this email for later reference.</p>
             ...
             <div style="border:#CCCCCC 1px solid; padding:10px; margin:0 0 15px 0;">
                ...
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Reference number: </strong>{$api->subscription->id}</p>
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Name: </strong>{$api->subscription->name}</p>
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Email: </strong>{$api->subscription->email}</p>
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Subscription: </strong>{$api->offerName}</p>
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Expires on: </strong>{format_ansi_date ansiDate=$api->subscription->expiryDate format='%d %B %Y'}</p>
                <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 5px 0; padding:0; color:#000000; line-height:18px;"><strong>Payment method: </strong>{$api->paymentMethod}</p>
			</div>
           </div>	 </td>
  </tr>
    ...
    <table width="600" height="219" border="0" cellpadding="0" cellspacing="0" background="http://www.clarityenglish.com/images/email/ieltspractice/img_btm_study.jpg">
                    <tr>
                      ...
                      <td width="367" height="233" valign="top">
                   	    <p style="font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 13px; margin:0 0 15px 0; padding:0; color:#000000; line-height:18px;">Please feel free to contact us at <a href='mailto:support@ieltspractice.com'>support@ieltspractice.com</a> if you have any questions.</p>
