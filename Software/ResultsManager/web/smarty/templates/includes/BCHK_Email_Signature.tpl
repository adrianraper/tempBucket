{* if $domain|lower|stristr:'roadtoielts.com' *}
{* if $smarty.server.SERVER_NAME|lower|stristr:'roadtoielts.com' *}
{assign var='supportEmail' value='support@roadtoielts.com'}
...
<span style="margin: 0 0 10px 0; padding:0;  font-weight:bold; font-style:italic; font-size:11px" >Road to IELTS Support Team</span>
