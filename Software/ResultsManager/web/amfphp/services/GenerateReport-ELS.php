...
// NOTES to run. You must signin to RM as a teacher for this group first and keep that running in browser.
$groupID = "35026";
$groupName = "Grunge";
$startDate = '2018-01-01';
$endDate = '2018-01-12';

$forReportablesIDObjects = json_decode(stripslashes('[{"Course":"2015061010000","Title":"61"}]'), true);
$template = "standard";
$opts = json_decode(stripslashes('{	"headers": {
		"courses": "Essays for and agin",
		"forReportDetail": "All exercises",
		"forReportLabel": "Exercise details",
		"onReport": "Grunge all records",
		"dateRange": "From then to now",
		"onReportLabel": "Group(s)",
		"titles": "Practical Writing",
		"attempts": "All attempts"
	},
	"toDate": "2018-01-12 23:59:59",
	"detailedReport": true,
...
$onReportablesIDObjects = json_decode(stripslashes('[{"Group":"35026"}]'), true);
$forClass = "Exercise";
$onClass = "Group";
...
$reportDom = $clarityService->getReportELS($onReportablesIDObjects, $onClass, $forReportablesIDObjects, $forClass, $opts, $reportType);
