...
class Title extends Content {
	...
	// m#404 and a licence control start date
    var $licenceControlStartDate;
    ...
    public function addDetails($productDetails) {
	    $this->name = (isset($productDetails['name'])) ? $productDetails['name'] : null;
	    $this->architectureVersion = (isset($productDetails['architectureVersion'])) ? $productDetails['architectureVersion'] : null;
	    $this->logoHref = (isset($productDetails['logoHref'])) ? $productDetails['logoHref'] : null;
    }
    /*
	...
	public function fromDatabaseObj($obj, $db = null) {
		...
		// m#404 Merge old Licence class into this one, simply calculate a licence control start date
        $this->licenceControlStartDate = $this->findLicenceClearanceDate();
	}

    // m#404 Copied from Licence class
