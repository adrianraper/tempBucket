...
$forReportablesIDObjects = json_decode(stripslashes('[{"Group":"94992"}]'), true);
$template="CEFSummary";
$opts=json_decode(stripslashes('{"includeInactiveUsers":false,"includeStudentID":false,"headers":{"forReportDetail":"Jordan, Makani phase 2","forReportLabel":"Group(s)","onReport":"LearnEnglish Level Test","dateRange":"","onReportLabel":"Title(s)","attempts":"All"},"detailedReport":false,"attempts":""}'), true);
...
$reportDom = $clarityService->getDebugReport($onReportablesIDObjects, $onClass, $forReportablesIDObjects, $forClass, $opts, $reportType);
