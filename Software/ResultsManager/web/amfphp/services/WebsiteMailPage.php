...
function sendEmail($templateID) {
	...
	$clarityReceiver = "sales@clarityenglish.com";
	// I can't see how to use quote marks to let me have a comma. Leave for now.
	$clarityNews = "Nicole Lung Clarity <news@clarityenglish.com>";
	$clarityInfo = "Clarity Info <info@clarityenglish.com>";
	$claritySupport = "Clarity Support <support@clarityenglish.com>";
	$clarityCLSSupport = "Clarity Support <support@claritylifeskills.com>";
	...
	switch ($templateID) {
		...
		case 4: # enquiry form - to customer
			...
			if ($data['requestID']=="1") {
				...
				$subject = "Price enquiry acknowledgement";
		...
		case 22: #the latest issue of CLS enews - to Customer
			$body = file_get_contents("$templateFolder/email_CLS_enews_toCustomer.htm");
			$subject = "Get the English skills you need for your career at ClarityLifeSkills, June 2011";
			$from = $clarityCLSSupport;
			$to = $data['customerEmail'];
			break;
		...
		case 13: # Price enquiry page - to Clarity
		...
		case 21: #ClS Newsletter Subscription Notification - to Customer
			...
			$to = $data['customerEmail'];
			$subject = "ClarityLifeSkills.com Newsletter";
			$from = $clarityCLSSupport;
			break;
		...
		case 27: # ClarityLifeSkills contact us - to Customer
			...
			$to = $data['email'];
			$subject = "ClarityLifeSkills.com, thank you for your enquiry";
			$from = $clarityCLSSupport;
			break;
		default:
			return false;
