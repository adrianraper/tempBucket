...
public class CheckBoxIcon extends Border
{
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		var disabledBorderColor:uint = getStyle("disabledBorderColor");
		...
		var disabledBorderColorDrk1:Number =
			ColorUtil.adjustBrightness2(disabledBorderColor, -50);
		...
		switch (name)
		{
			...
			case "disabledIcon":
			{
				...
				disFillAlphas = [ Math.max(0, disabledFillAlphas[0] - 0.15),
								  Math.max(0, disabledFillAlphas[1] - 0.15) ];

				// border
				drawRoundRect(
					0, 0, w, h, 0,
					[ disabledBorderColor, disabledBorderColorDrk1 ], 0.5,
					verticalGradientMatrix(0, 0, w, h),
					GradientType.LINEAR, null, 
					{ x: 1, y: 1, w: w - 2, h: h - 2, r: 0 }); 
