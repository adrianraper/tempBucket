package com.clarityenglish.testadmin.view.management.ui {
	 ...
	 * @author Clarity
	 */
	public class TAManageableCMManager extends CMManager implements CopyReceiver {
		...
		public function TAManageableCMManager(target:InteractiveObject) {
