package com.clarityenglish.tensebuster
{
	...
	public class TenseBusterPreloader extends SparkDownloadProgressBar
	{
		...
		public function TenseBusterPreloader() {
			super();
		...
		protected function onResize(event:Event = null):void {
			if (preloaderDisplay) {
				preloaderDisplay.scaleX = 1.7;
				preloaderDisplay.scaleY = 1.7;
				preloaderDisplay.x = Math.round((stage.stageWidth - preloaderDisplay.width)/ 2 + 80);
				preloaderDisplay.y = Math.round((stage.stageHeight - preloaderDisplay.height)/ 2 + 80);
			}
		}
