	...
	public class SectionNavigatorTabBarSkin extends TabbedViewNavigatorTabBarSkin {
		...
		override protected function createChildren():void {
			if (!firstButton) {
				...
				firstButton.skinClass = skins.ielts.zone.ui.SectionNavigatorTabBarButtonSkin;
			}
			
			if (!lastButton) {
				lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				lastButton.skinClass = skins.ielts.zone.ui.SectionNavigatorTabBarButtonSkin;
			}
			
			if (!middleButton) {
				middleButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				middleButton.skinClass = skins.ielts.zone.ui.SectionNavigatorTabBarButtonSkin;
			}
