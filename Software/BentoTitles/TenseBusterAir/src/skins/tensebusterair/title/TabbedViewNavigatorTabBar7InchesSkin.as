...
package skins.tensebusterair.title
{
	...
	public class TabbedViewNavigatorTabBar7InchesSkin extends ButtonBarSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 * 
		 */
		public function TabbedViewNavigatorTabBar7InchesSkin()
		{
			super();
		}
		...
		override protected function createChildren():void
		{
			if (!firstButton)
			{
				...
				firstButton.skinClass = skins.tensebusterair.title.HomeButtonBarButton7InchesSkin;
			}
			
			if (!lastButton)
			{
				lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				lastButton.skinClass = skins.tensebusterair.title.ProgressButtonBarButton7InchesSkin;
			}
