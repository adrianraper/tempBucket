package skins.tensebusterair.title
{
	...
	public class SizedTabbedViewNavigatorSkin extends MobileSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 * 
		 */
		public function SizedTabbedViewNavigatorSkin()
		{
			super();
		}
		 ...
		 */
		public var hostComponent:SizedTabbedViewNavigator;
		...
		override protected function layoutContents(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			if (tabBar.includeInLayout)
			{
				...
				if (hostComponent.size == "10Inches") {
					tabBar.setLayoutBoundsSize(645, tabBarHeight);
					tabBar.setStyle("skinClass", TabbedViewNavigatorTabBar10InchesSkin);
					tabBar.setLayoutBoundsPosition(FlexGlobals.topLevelApplication.stage.stageWidth / 2 - 628, unscaledHeight - tabBarHeight);
				} else {
					tabBar.setLayoutBoundsSize(470, tabBarHeight);
					tabBar.setStyle("skinClass", TabbedViewNavigatorTabBar7InchesSkin);
					tabBar.setLayoutBoundsPosition(FlexGlobals.topLevelApplication.stage.stageWidth / 2 - 510, unscaledHeight - tabBarHeight);
				}				
