...
package skins.tensebusterair.title
{
	...
	public class TabbedViewNavigatorTabBar10InchesSkin extends ButtonBarSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 * 
		 */
		public function TabbedViewNavigatorTabBar10InchesSkin()
		{
			super();
		}
		...
		override protected function createChildren():void
		{
			if (!firstButton)
			{
				...
				firstButton.skinClass = skins.tensebusterair.title.HomeButtonBarButton10InchesSkin;
			}
			
			if (!lastButton)
			{
				lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				lastButton.skinClass = skins.tensebusterair.title.ProgressButtonBarButton10InchesSkin;
			}
