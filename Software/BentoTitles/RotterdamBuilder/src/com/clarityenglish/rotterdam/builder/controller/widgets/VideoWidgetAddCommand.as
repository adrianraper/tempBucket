package com.clarityenglish.rotterdam.builder.controller.widgets {
	...
	public class VideoWidgetAddCommand extends SimpleCommand {
		...
		public override function execute(note:INotification):void {
			...
			facade.sendNotification(RotterdamNotifications.WIDGET_ADD, <exercise type="video" src={src} column="0" span="2" title="New video widget"><text>{textFlowString}</text></exercise>);
		}
