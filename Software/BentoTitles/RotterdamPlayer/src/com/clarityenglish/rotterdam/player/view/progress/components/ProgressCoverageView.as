package com.clarityenglish.rotterdam.player.view.progress.components {
	...
	import com.clarityenglish.rotterdam.player.view.progress.ui.CoverageExerciseComponent;
	import com.clarityenglish.rotterdam.player.view.progress.ui.CoverageUnitComponent;
	import com.clarityenglish.rotterdam.player.view.progress.ui.ProgressBarRenderer;
	...
	public class ProgressCoverageView extends BentoView {
		...
		[SkinPart]
		public var exerciseCoverage:CoverageExerciseComponent;
		
		[Bindable]
		public var exerciseCoverageDataProvider:XMLListCollection;
		...
		private function focusCourse(courseClass:String = null):void {
			...
			if (detailDataProvider) {
				for each (var unitNode:XML in detailDataProvider.course.(@["class"] == courseClass).unit) {
					exerciseCoverageDataProvider = new XMLListCollection(unitNode.exercise);
				}
