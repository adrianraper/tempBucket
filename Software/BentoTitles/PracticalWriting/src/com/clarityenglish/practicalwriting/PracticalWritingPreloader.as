...
public class PracticalWritingPreloader extends SparkDownloadProgressBar {
    private var preloaderDisplay:CommonPreloaderDisplay;
    ...
    private var swfEstimate:Number = 2000000; // published size

    public function PracticalWritingPreloader() {
        super();
    ...
    protected function onResize(event:Event = null):void {
        if (preloaderDisplay) {
            preloaderDisplay.scaleX = 1;
            preloaderDisplay.scaleY = 1;
            preloaderDisplay.x = Math.round((stage.stageWidth - preloaderDisplay.width)/ 2 - 30);
    ...
    override protected function createChildren():void {
        if (!preloaderDisplay) {
            preloaderDisplay = new CommonPreloaderDisplay();
