...
//_global.myTrace("textWithFields ==== , in findReplace");
...
//_global.myTrace("textWithFields ==== , in convertCurlyQuote");
	var build = myString;
...
//_global.myTrace("textWithFields ==== , in TextWithFieldClass");
...
//_global.myTrace("textWithFields ==== , in init");
...
//_global.myTrace("textWithFields ==== , in resetSize");
...
//_global.myTrace("textWithFields ==== , in setSize");
...
//_global.myTrace("textWithFields ==== , in getSize");
...
//_global.myTrace("textWithFields ==== , in setHtmlText: myText" + myText);
	//myTrace("twf.sHT with " + myText);
	//myTrace("twf.sHT");
...
//_global.myTrace("textWithFields ==== , in getHtmlText");
//	trace("in getText");
...
//_global.myTrace("textWithFields ==== , in setFieldTextFormat, fieldID: " + fieldID + ", fields.length: " + this.fields.length);
	//myTrace("twf.setFieldTextFormat");
	var fieldIDX=TWF.lookupArrayItem(this.fields, fieldID, "id");
//_global.myTrace("textWithFields ==== , fieldIDX: " + fieldIDX);
...
//_global.myTrace("textWithFields ==== , in getFieldTextFormat");
	var fieldIDX=TWF.lookupArrayItem(this.fields, fieldID, "id");
...
//_global.myTrace("textWithFields ==== , in setFieldText, fieldID: " + fieldID + ", text: " + text + ", partialRefresh: " + partialRefresh);
	...
	if (partialRefresh) {
		...
		//trace("changing all fields after " + startSel + " by " + lengthChange);
...
//_global.myTrace("textWithFields ==== , in getFieldText");
...
//_global.myTrace("textWithFields ==== , in setHideCursor");
	if (flag == true) {
...
//_global.myTrace("textWithFields ==== , in setEvents");
...
//_global.myTrace("textWithFields ==== , in refresh");
	//myTrace("twf.refresh");
	// for speed testing
...
//_global.myTrace("textWithFields ==== , in getFieldObject");
	var fieldIDX=TWF.lookupArrayItem(this.fields, fieldID, "id");
...
//_global.myTrace("textWithFields ==== , in clearCanvas");
...
//_global.myTrace("textWithFields ==== , in clearOverlay");
...
//_global.myTrace("textWithFields ==== , in buildTextAndFields ====================================");
	...
	//myTrace("bTAF with " + this.original.text);
	//myTrace("bTAF with " + this.original.htmlText);
...
//	this.holder.border	= true;	// v6.5.4.2 Yiu, debug, uncomment this to show the textWithFieldBorder 
	...
	for (var i=0;i<this.maxLength; i++) {
		...
		if (thisTF.url != lastURL) {
			//trace("at i=" + i + " lastURL=" + lastURL + " newURL=" + thisTF.url);
...
//_global.myTrace("textWithFields ==== , in showLineBreaks");
	var plainText = new String(this.holder.text);
	for (var i in this.lines) {
...
//_global.myTrace("textWithFields ==== , in measureFields, fields length: " + this.fields.length);
...
//_global.myTrace("textWithFields ==== , in measureFields, i: " + i);
...
//_global.myTrace("textWithFields ==== , in addFieldCovers");
...
//_global.myTrace("textWithFields ==== , in removeFiledCovers");
	for (var i in this.fields) {
...
//_global.myTrace("textWithFields ==== , in resetFieldCovers");
	for (var i in this.fields) {
...
//_global.myTrace("textWithFields ==== , in disableField");
...
//_global.myTrace("textWithFields ==== , in enableField");
...
//_global.myTrace("textWithFields ==== , in addFieldCover");
...
//_global.myTrace("textWithFields ==== , in addCoverfunction");
...
//_global.myTrace("textWithFields ==== , in onRollout");
...
//_global.myTrace("textWithFields ==== , in onDragout");
...
//_global.myTrace("textWithFields ==== , in setText: " + text);
...
//_global.myTrace("textWithFields ==== , in clearText");
...
//_global.myTrace("textWithFields ==== , in getText");
...
//_global.myTrace("textWithFields ==== , in showDropPosition");
		var thisTWF = this._parent;
		...
		this.onMouseMove = function() {
//_global.myTrace("textWithFields ==== , in onMouseMove");
...
//_global.myTrace("textWithFields ==== , in hideDropPosition");
...
//_global.myTrace("textWithFields ==== , in removeCoverFunctions");
...
//_global.myTrace("textWithFields ==== , in getFieldCover 2");
...
//_global.myTrace("textWithFields ==== , in  setFieldBackground");
...
//_global.myTrace("textWithFields ==== , in clearFieldBackground");
	var fieldIDX = TWF.lookupArrayItem(this.fields, fieldID, "id");
	if (fieldIDX >= 0) {
...
//_global.myTrace("textWithFields ==== , in setFieldTick");
...
//_global.myTrace("textWithFields ==== , in clearFieldTick");
	var fieldIDX = TWF.lookupArrayItem(this.fields, fieldID, "id");
	if (fieldIDX >= 0) {
		// v6.4.2.7 Only ever put a tick on the 0 part of a field
		//for (var j=0; j<this.fields[fieldIDX].coords.length; j++) {
...
//_global.myTrace("textWithFields ==== , in addDropsForHitTest");
//	var startTime = new Date();
	...
	if (this.hitTest(_root._xmouse, _root._ymouse)) {
		...
		if ((this._y+thisY) > (this._parent._parent.getScrollPosition().y - 8)) {	        // v6.5.4.2 Yiu position should move when parent move, for hint button popbox, Bug ID 1223
			...
			if (Key.isDown(Key.CONTROL)) {	
				...
				// var thisX = this._xmouse; // v6.5.4.2 Yiu commented, Bug ID xxx
				// var thisY = this._ymouse; // v6.5.4.2 Yiu commented, Bug ID xxx
				//trace("x=" + thisX + " y=" + thisY);
				var i = this.lines.length;
				//myTrace("this twf has " + i + " lines");
				var firstChar 		= 0;

				// v6.5.4.2 Yiu, add the _parent.y if  
				var nExtraAddition	= 0;
				if(bIsButtonPopBox)
					nExtraAddition	= this._parent._y;

				while (i--) {
					//myTrace("lines[" + i + "].idx=" + this.lines[i].idx + " y=" + this.lines[i].y);
					if (this.lines[i].y + nExtraAddition < thisY) {
...
//_global.myTrace("textWithFields ==== , in getWordEdges");
...
//_global.myTrace("textWithFields ==== , in findCursorPosition");
...
//_global.myTrace("textWithFields ==== , in setSplitGaps");
...
//_global.myTrace("textWithFields ==== , in getVersion");
...
//_global.myTrace("textWithFields ==== , in setCountDownText");
...
//_global.myTrace("textWithFields ==== , in setCOuntDownSettings");
...
//_global.myTrace("textWithFields ==== , in wordMatch");
...
//_global.myTrace("textWithFields ==== , in guessCountDownWord");
...
//_global.myTrace("textWithFields ==== , in showFullText");
...
//_global.myTrace("textWithFields ==== , in findWordEdges");
...
//_global.myTrace("textWithFields ==== , in buildLineDetails");
	//myTrace("in bLD");
	var thisTF = new TextFormat();
...
//_global.myTrace("textWithFields ==== , in setBackground");
