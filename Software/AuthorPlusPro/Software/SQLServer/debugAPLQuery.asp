...
'dim XMLRequest
'XMLRequest = Request.QueryString("xml")
'XMLRequest="<query><purpose>checkLogin</purpose><username>BULATS</username><password>BULATS</password><rootID>10357</rootID></query>"
'returnValue = XMLDoc.load(XMLRequest)
xmlNode = "<db>"
...
Else
	...
	myQuery.purpose = "checkLogin"
	myQuery.Username= "Adrian Raper"
